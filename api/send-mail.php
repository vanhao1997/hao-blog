...
switch ($action) {
    ...
    case 'reply':
        ...
        if ($success) {
            ...
            echo json_encode(["error" => "Gửi email thất bại. Kiểm tra cấu hình mail server."]);
        }
        break;
    ...
    case 'newsletter':
        ...
        // Set max execution time for bulk sends
        set_time_limit(300);
    ...
    case 'test':
        ...
        if ($success) {
            ...
            http_response_code(500);
            echo json_encode(["error" => "Gửi email thất bại. Kiểm tra PHP mail() configuration trên server."]);
        }
        break;
